...
![guide](https://pub-35f8b3b9fb1540899fcf1e6fb1fab07b.r2.dev/guide.png)
...
![demo](https://pub-35f8b3b9fb1540899fcf1e6fb1fab07b.r2.dev/demo.gif)
...
![dom](https://pub-35f8b3b9fb1540899fcf1e6fb1fab07b.r2.dev/web-api.jpg)
...
<body>
  ...
  <script>
   ...
   const lis = document.querySelectorAll('li')  // 获取第一个 p 元素
  </script>
</body>
</html>
```
...
3. 通过 classList 操作类控制 CSS
    ...
    <body>
        ...
        <script>
            // 1.获取元素
            // let box = document.querySelector('css 选择器')
